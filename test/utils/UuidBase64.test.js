...
describe('@UuidBase64 Conversion tests', () => {
    it('@UuidBase64.1 - should convert UUID to short string and back correctly', () => {
        // Given
    ...
    it('@UuidBase64.2 - should convert specific UUID to expected short string', () => {
        // Given
    ...
    it('@UuidBase64.3 - should handle different input formats (padding, whitespace)', () => {
    ...
    it('@UuidBase64.4 - should handle edge cases (null UUID, max value UUID)', () => {
